...
@section('content')
    ...
    <section class="content">
          ...
          <div class="box box-info">
            <form method="post" action="{{ url('admin/program/create/submit') }}" >
                ...
                <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control" id="judul" placeholder="judul program">
                        </div>
                        <div class="form-group">
                            <label for="detail">Detail program</label>
                            <textarea id="summernote" name="program_info"></textarea>
                        </div>
                </div>
