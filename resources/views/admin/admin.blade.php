    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{URL::asset('AdminLTE/pages/tables/simple.html')}}"><i class="fa fa-circle-o"></i> Simple tables</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/tables/data.html')}}"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>
        <li>
          <a href="{{URL::asset('AdminLTE/pages/calendar.html')}}">
        ...
        <li>
          <a href="{{URL::asset('AdminLTE/pages/mailbox/mailbox.html')}}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{URL::asset('AdminLTE/pages/examples/invoice.html')}}"><i class="fa fa-circle-o"></i> Invoice</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/profile.html')}}"><i class="fa fa-circle-o"></i> Profile</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/login.html')}}"><i class="fa fa-circle-o"></i> Login</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/register.html')}}"><i class="fa fa-circle-o"></i> Register</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/lockscreen.html')}}"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/404.html')}}"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/500.html')}}"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/blank.html')}}"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="{{URL::asset('AdminLTE/pages/examples/pace.html')}}"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('AdminLTE/dist/img/user4-128x128.jpg')}}" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('AdminLTE/dist/img/user3-128x128.jpg')}}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('AdminLTE/dist/img/user2-160x160.jpg')}}" alt="user image" class="offline">
